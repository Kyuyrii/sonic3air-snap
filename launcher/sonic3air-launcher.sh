...
function detect_game () {
    ...
    local not_found_text="To play Sonic 3: A.I.R, you need Sonic 3 &amp; Knuckles from the SEGA Mega Drive and Genesis Classics collection installed on Steam.<br/>Please install it and restart the game.<br/>If your Steam install is in an unusual place, please locate the game's ROM file manually.<br/>Manually set game location?"
